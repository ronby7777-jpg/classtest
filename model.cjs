const defaults = { size: 150, speed: 85, rangeStart: 0, rangeEnd: 100, volume: 65, soundChance: 25, displayId: null, assets: {idle:null, walk:null, pat:null}, random: [] };
function normalize(raw = {}) {
  ...
  return {size:num('size',64,360), speed:num('speed',10,240), rangeStart:start, rangeEnd:Math.max(start+5,num('rangeEnd',5,100)), volume:num('volume',0,100), soundChance:num('soundChance',0,100), displayId:raw.displayId ?? null,
